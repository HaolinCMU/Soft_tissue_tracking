...
def trainValidateNet(train_dataloader, valid_dataloader, neural_net, learning_rate, 
    ...
    for epoch in range(num_epochs):
        ...
        print("Epoch: ", epoch, "| train loss: %.6f | valid loss: %.6f  " 
...
def main(): 
    ...
    if isKCenter:
        initial_pt_index = 333 # Initial point index for k-center clustering. Randomly assigned. Current best result: 584 (best mean_max_nodal_error: 0.92 mm)
        ...
        if center_indices_list != []: FM_indices = center_indices_list[0:FM_num]
            ...
            FM_indices = [333, 224, 259, 329, 327] # Optimal FM indices. Back-up choice when the returned list is empty.  
