...
def main():
    ...
    laplacian_file_name = "data_kidney.mat"
    ...
    outer_surface_region_number = 1 # The region number of the outer surface. 
    ...
    mdict = {"force_field_interpolated": force_field_new, # The interpolated force fields. 
             ...
             "force_field_random": generateForceFields(laplacian_matrix, sample_num, 
                                                       ...
                                                       eigen_num=eigenNum, scalar=force_scalar), # A new batch of reconstructed force fields. Should be independent of the LBO-reconstructed force field matrix used for interpolation. 
