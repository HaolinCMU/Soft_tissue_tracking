...
current_directory = "C:/Users/13426/Desktop/soft_tissue_tracking/code/ANN/nonlinear/aorta" # Directory with only input files of stage1 and stage2. 
...
for file_name in file_list:
    ...
    if target_path_odb_temp != "" and np.random.rand() <= 0.9: os.remove(target_path_odb_temp)
    else: continue
