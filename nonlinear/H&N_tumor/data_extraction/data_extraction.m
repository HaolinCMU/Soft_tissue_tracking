...
parfor i = 1:length(dat)
    ...
    disp(strcat("Node file: ", namePart, " - extracting started. "));
    disp(strcat("Node file: ", namePart, " - extracting running... "));
    ...
    disp(strcat("Node file: ", namePart, " - stress extracting completed. "));
    ...
    disp(strcat("Node file: ", namePart, " - coord extracting completed. "));
    disp(strcat("Node file: ", namePart, " - all completed. "));
