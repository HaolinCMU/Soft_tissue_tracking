%
% Output of type 2 from the ABAQUS results file to MATLAB
%
% Syntax
%     #out#=readFilCat2(#Rec#,#recordKey#,zeros(1,0),zeros(1,0))
%
% Description
%     Read type 2 output from an Abaqus results file generated from the
...
%     The output of type 2 corresponds to records containing an integer as
%     the first output of each record, and floating point numbers as the
%     subsequent output. See section ''5.1.2 Results file output format''
...
%         record keys for the extraction of results of type 2.
